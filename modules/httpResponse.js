 ...
 * Default content type is text/html.
 */
let _internalServerError = function internalServerError(request, response, body, contentType = contentTypes.HTML) {
    _send(request, response, body, statusCodes.INTERNAL_SERVER_ERROR, contentType);
};
